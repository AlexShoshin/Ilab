...
{                                                 //and question, explaining with that the answers are different
    ...
    char *thought_answer = malloc(100 * sizeof(char));      //answer that user thought
    char *symbol = malloc(100 * sizeof(char));
    char *diff_question = malloc(100 * sizeof(char));       //question that shows with what answers are different
    ...
    struct Node *cur = malloc(sizeof(struct Node));                 //current node before changing
    cur = tree;
...
int main()
{
    ...
    char *file_string = malloc(LENGHT_OF_FILE_STRING * sizeof(char));
    char *symbol = malloc(100 * sizeof(char));
    ...
    fclose(input);
    printf("\n");
    printf("Datafile found, tree constructed, I'm ready!\n");
    ...
    char *change_buf = malloc(100 * sizeof(char));  //is needed to change wording of questions or answers
